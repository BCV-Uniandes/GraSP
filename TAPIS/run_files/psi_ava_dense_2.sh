...
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=2 python -B tools/run_net.py \
--cfg $CONFIG_PATH \
NUM_GPUS 1 \
...
# Experiment setup
FOLD="fold1" 
EXP_NAME="MVITv1_dense_mf_swins"
TASK="ACTIONS"
ARCH="MVIT"
CHECKPOINT="/home/nayobi/Endovis/Final-TAPIR/data/PSIAVA_v2/weights/"$FOLD"/checkpoint_best_phases.pyth"
...
ANNOT_DIR="./data/PSIAVA_v2/data_annotations/"$DATA_VER"/"$FOLD"/coco_anns"
COCO_ANN_PATH="./data/PSIAVA_v2/data_annotations/"$DATA_VER"/"$FOLD"/coco_anns/val_coco_anns.json"
FF_TRAIN="./data/PSIAVA_v2/data_annotations/"$DATA_VER"/"$FOLD"/train/bbox_features_mask2former_swins.pth" 
FF_VAL="./data/PSIAVA_v2/data_annotations/"$DATA_VER"/"$FOLD"/val/bbox_features_mask2former_swins.pth"
...
ENDOVIS_DATASET.ANNOTATION_DIR $ANNOT_DIR \
ENDOVIS_DATASET.COCO_ANN_DIR $COCO_ANN_PATH \
ENDOVIS_DATASET.TRAIN_PREDICT_BOX_JSON "train_coco_preds_mask2former_swins.json" \
ENDOVIS_DATASET.TEST_PREDICT_BOX_JSON "val_coco_preds_mask2former_swins.json" \
BN.NUM_BATCHES_PRECISE 72 \
FEATURES.TRAIN_FEATURES_PATH $FF_TRAIN \
FEATURES.VAL_FEATURES_PATH $FF_VAL \
TEST.DATASET psi_ava_dense \
...
ANNOT_DIR="./data/PSIAVA_v2/data_annotations/"$DATA_VER"/"$FOLD"/coco_anns"
COCO_ANN_PATH="./data/PSIAVA_v2/data_annotations/"$DATA_VER"/"$FOLD"/coco_anns/val_coco_anns.json"
FF_TRAIN="./data/PSIAVA_v2/data_annotations/"$DATA_VER"/"$FOLD"/train/bbox_features_faster.pth" 
FF_VAL="./data/PSIAVA_v2/data_annotations/"$DATA_VER"/"$FOLD"/val/bbox_features_faster.pth"
...
ENDOVIS_DATASET.ANNOTATION_DIR $ANNOT_DIR \
ENDOVIS_DATASET.COCO_ANN_DIR $COCO_ANN_PATH \
ENDOVIS_DATASET.TRAIN_PREDICT_BOX_JSON "train_coco_preds_faster.json" \
ENDOVIS_DATASET.TEST_PREDICT_BOX_JSON "val_coco_preds_faster.json" \
TEST.DATASET psi_ava_dense \
TRAIN.DATASET psi_ava_dense \
BN.NUM_BATCHES_PRECISE 72 \
FEATURES.TRAIN_FEATURES_PATH $FF_TRAIN \
