...
_C.ENDOVIS_DATASET.DETECTION_SCORE_THRESH = 0.9
...
_C.ENDOVIS_DATASET.FULL_TEST_ON_VAL = False

# The name of the file to the ava label map.
_C.ENDOVIS_DATASET.LABEL_MAP_FILE = ""

# The name of the file to the ava exclusion.
_C.ENDOVIS_DATASET.EXCLUSION_FILE = ""
...
_C.ENDOVIS_DATASET.COCO_ANN_DIR = ""

# Dataset cataracts
_C.ENDOVIS_DATASET.CATARACTS = False

# Supported Tasks
_C.ENDOVIS_DATASET.TASKS = ["phases", "steps", "gestures", "tools", "actions", "targets", "triplets"]

# Region Tasks
_C.ENDOVIS_DATASET.REGION_TASKS = ["tools", "actions", "targets"]
...
# Task metrics
_C.TASKS.METRICS = ["mAP@IoU", "mAP", "mAP", "mAP@IoU"]
...
_C.FEATURES.SAM_MLP = False

_C.FEATURES.SAM_PROMPT = False

_C.FEATURES.SAM_BOX = False
